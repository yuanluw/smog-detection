...
def train(net, train_data, val_data, optimizer, criterion, arg):
    ...
    if os.path.exists(os.path.join(cur_path, "pre_train", str("DNCNN" + "_.pkl"))):
        os.remove(os.path.join(cur_path, "pre_train", str("DNCNN" + "_.pkl")))
    torch.save(best_state_dict, os.path.join(cur_path, "pre_train", str("DNCNN" + "_.pkl")))
